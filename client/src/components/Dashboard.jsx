  ...
  return (
    <div className="flex ">
      <div className="w-full">
        {/* nav */}
        <div className="h-[5.5rem] relative flex justify-between py-2 items-center px-[5%]">
          ...
          <div className="flex gap-5">
            ...
            >
              Search
              {isFiltered && (
                <span className="bg-green-400 absolute top-[2px] right-[2px] rounded-full h-[0.85rem] w-[0.85rem]"></span>
              )}
            </button>
            <button
