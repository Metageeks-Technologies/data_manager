...
const EditedData = () => {
  ...
  DataToShow=DataToShow.filter(item => editRequestData.some(ed=>item._id===ed.dataId))

  for (let i = 0; i < editRequestData.length; i++) {
    const editData = editRequestData[i];

    const data = DataToShow.find((ed) => editData.dataId === ed._id);
    // console.log(editData);
    if(data)data.editStatus = editData?.status;
  ...
  return (
    <>
      ...
      <div className="bg-[#f0f4f8]  py-2 px-[3rem] border-t border-l border-gray-300">
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          ...
                          {obj.address[1] && (
                            <p className="text-blue-600">{obj.address[1]}</p>
                          )}
                        </td>
                        <td
                          scope="row"
                        ...
                        >
                          ...
                          {obj.profession[1] && (
                            <p className="text-blue-600">{obj.profession[1]}</p>
                          )}
                        </td>
                        <td
                          scope="row"
