          ...
          content.push(
            <Link
              ...
              className={`
                    ...
                    relative z-10 cursor-pointer inline-flex items-center border px-4 py-2 text-sm font-medium focus:z-20`}
              key={i}
            >
              {" "}
              {i}
            ...
            <div>
              ...
              >
                <Link
                  ...
                  className={`${
                    page === 1 && "hidden"
                  } relative inline-flex items-center rounded-l-md border   px-2 py-2 text-sm font-medium hover:bg-gray-50 focus:z-20`}
                >
                ...
                <Link
                  ...
                  } relative inline-flex items-center rounded-r-md border px-2 py-2 text-sm font-medium hover:bg-gray-50 focus:z-20`}
                >
