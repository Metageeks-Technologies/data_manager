    ...
    <>
      ...
      <div className="custom-scrollbar  h-fit relative overflow-x-auto shadow-md sm:rounded-lg">
        <table className="w-full  text-sm text-center ">
          ...
          <TableContent  data={currentItems} role={"admin"} dataType={"deleted"} />
        </table>
      </div>
    </>
...
const Trash = () => {
  ...
  return (
    <>
     <div style={{ height: "calc(100vh - 5.5rem)" }} className="bg-[#f0f4f8]  py-5 px-[3rem] border-t border-l border-gray-300">
        ...
        {deletedData.length === 0 && isLoading ? (
          ...
          <>
            <Items currentItems={deletedData} form={form} fun={getAllDeletedData} />
          </>
        )}
      </div>
    </>
