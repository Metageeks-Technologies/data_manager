...
import { DeleteAdminData, Loader, SearchContainer } from "../../components";
            ...
            return (
              <tr key={obj._id} className="bg-white border-b dark:bg-gray-100 ">
                ...
                <td className="px-6 py-4">
                 <DeleteAdminData id={obj._id} isTrash/> 
                </td>
...
const Trash = () => {
  const { getAllData,getAllDeletedData,toggleAction,deletedData, isLoading,openSearchBar,searchBar,setPage,pageInfo,page, } = useAppContext();
    ...
    <>
      ...
      {/* <PaginationContainer form={form}/> */}
        ...
        {/* {isLoading ? (
          ...
          <>
          <Items currentItems={ deletedData} />  
          </>
        )} */}
        <Items currentItems={ deletedData} />
        {/* <Pagination {...pageInfo} /> */}
